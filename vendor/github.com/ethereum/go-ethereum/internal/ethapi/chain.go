...
func (s *PublicChainAPI) CreateChildChain(ctx context.Context, from common.Address, chainId string,
	minValidators *hexutil.Uint, minDepositAmount *hexutil.Big, startBlock, endBlock *hexutil.Uint64, gas *hexutil.Uint64, gasPrice *hexutil.Big) (common.Hash, error) {
...
//	startBlock, _ := etd.GetUInt64(CCC_ARGS_START_BLOCK)
//	endBlock, _ := etd.GetUInt64(CCC_ARGS_END_BLOCK)
//
