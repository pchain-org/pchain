...
import (
	...
	"github.com/ethereum/go-ethereum/consensus/tendermint/config/tendermint_test"
...
var data_dir = path.Join(cmn.GoPath, "src/github.com/ethereum/go-ethereum/consensus/tendermint/consensus", "test_data")
