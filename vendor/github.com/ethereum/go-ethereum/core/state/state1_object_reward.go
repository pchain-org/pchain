...
func (c *state1Object) getRewardTrie(db Database) Trie {
	if c.rewardTrie == nil {
		var err error
...
func (self *state1Object) GetEpochRewardBalance(db Database, key uint64) *big.Int {
...
func (self *state1Object) SetEpochRewardBalance(db Database, key uint64, rewardAmount *big.Int) {
	self.db.journal = append(self.db.journal, epochRewardBalanceState1Change{
...
func (self *state1Object) updateRewardTrie(db Database) Trie {
...
func (self *state1Object) updateRewardRoot(db Database) {
...
func (self *state1Object) CommitRewardTrie(db Database) error {
	self.updateRewardTrie(db)
	if self.dbErr != nil {
		return self.dbErr
	}
