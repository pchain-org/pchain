...
type AppConnMempool interface {
	...
	CheckTxAsync(tx []byte, cb func(*types.Response)) *abcicli.ReqRes
...
func (app *appConnConsensus) CommitSync(validators []*types.Validator, rewardPerBlock *big.Int, refund []*types.RefundValidatorAmount) (res types.Result) {
...
func (app *appConnMempool) CheckTxAsync(tx []byte, cb func(*types.Response)) *abcicli.ReqRes {
	return app.appConn.CheckTxAsync(tx, cb)
}
